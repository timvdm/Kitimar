...
void Rarey_smarts_part_15(OpenBabel::OBMol &mol)
{
    ...
    validate_contains<"[CH,CH2,CH3;!$([CH2]CC=[O,S])][F,Cl,Br,I,$(OS(=O)(=O)[#6,#1]),$(OS(=O)(=O)O[#6,#1])]">(mol);
    validate_contains<"[CH2,CH3][NX3][NX2]=[O,S]">(mol);
    validate_contains<"[CH2,CH]=C1C(=[O,SX2])**C1">(mol);
    validate_contains<"[CH2,CH]=[CH]C=C[$(N(=O)~O),$(C=O),$(C#N),$(S=O),$(C(=O)N),$(a)]">(mol);
    validate_contains<"[CH2,CH]=[CH][$(N(=O)~O),$(C=O),$(C#N),$(S=O),$(C(=O)N),$(a)]">(mol);
    validate_contains<"[CH2X4][#6X3]1:[$([#7X3H+,#7X2H0+0]:[#6X3H]:[#7X3H]),$([#7X3H])]:[#6X3H]:[$([#7X3H+,#7X2H0+0]:[#6X3H]:[#7X3H]),$([#7X3H])]:[#6X3H]1">(mol);
    ...
    validate_contains<"[CH2]=C[$(N(=O)~O),$(C=O),$(C#N),$(S=O),$(C(=O)N),$(a)]">(mol);
    ...
    validate_contains<"[CHR]=[CR][$(N(=O)~O),$(C=O),$(C#N),$(S=O),$(C(=O)N),$(a)]">(mol);
    ...
    validate_contains<"[CX3;$([C]([#6])[#6]),$([CH][#6])]=[NX2][#6]">(mol);
