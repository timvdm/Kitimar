...
void Rarey_smarts_part_19(OpenBabel::OBMol &mol)
{
    ...
    validate_contains<"[c;$([*Cl]),$([*H1])]1ccc(O)c(C)c1">(mol);
    validate_contains<"[c;$(c([cH])([cH,n&H0,O]))][F,Cl,Br,I]">(mol);
    validate_contains<"[c;$(c([n&H0,cH,S,O]))]-;!@[N;X3;!$(N[N,O,S])]">(mol);
    validate_contains<"[c;$(c[n&H0,cH,S,O])]-;!@[c;$(c[n&H0,cH,S,O])]">(mol);
    validate_contains<"[c;$(c[n&H0,cH,S,O])]-;!@[n]">(mol);
    validate_contains<"[c;X3;R;!$([c]@[N,n,S,s,O,o])]-;!@[#7;R;D3;$([#7]@[#6](=O))]">(mol);
    validate_contains<"[c;X3;R;!$([c]@[N,n,S,s,O,o])]-;!@[N;X3;!D1;!$(NC=;!@[N,O,S]);$(N([#6;!D1;R])[#6;!D1;R]!=,@[!D1])]">(mol);
    validate_contains<"[c;X3;R;!$([c]@[N,n,S,s,O,o])]-;!@[N;X3;!D1;!$(NC=;!@[N,O,S]);$(N([#6;!D1])[#6;!D1;R]!=,@[!D1])]">(mol);
    validate_contains<"[c;X3;R;!$([c]@[N,n,S,s,O,o])]-;!@[O;D2;$(O([#6;!D1;R])[#6;!D1;R][!D1]);!$(OCO);!$(OC=;!@*);!$(O[P,S])]">(mol);
    validate_contains<"[c;X3;R;!$([c]@[N,n,S,s,O,o])]-;!@[O;D2;$(O([#6;!D1;R])[#6;!D1][!D1]);!$(OCO);!$(OC=;!@*);!$(O[P,S])]">(mol);
    validate_contains<"[c;X3;R;!$([c]@[N,n,S,s,O,o])]-;!@[S;$(S(=O)([#6;!D1;R])[#6;!D1;R][!D1])]">(mol);
    validate_contains<"[c;X3;R;!$([c]@[N,n,S,s,O,o])]-;!@[S;D2;$(S([#6;!D1;R])[#6;!D1;R][!D1]);!$(SCS);!$(SC=;!@*);!$(S[P,S])]">(mol);
    validate_contains<"[c;X3;R;!$([c]@[N,n,S,s,O,o])]-;!@[c;X3;R;!$([c]@[N,n,S,s,O,o])]">(mol);
    validate_contains<"[c;X3;R;!$([c]@[N,n,S,s,O,o])]-;!@[n;!$(n@[#6](=O))]">(mol);
    validate_contains<"[c;X3;R;$([c]@[N,n,S,s,O,o])]-;!@[#7;R;D3;$([#7]@[#6](=O))]">(mol);
    validate_contains<"[c;X3;R;$([c]@[N,n,S,s,O,o])]-;!@[C;D3;R;!$([C]@[N,n,S,s,O,o])]">(mol);
    validate_contains<"[c;X3;R;$([c]@[N,n,S,s,O,o])]-;!@[N;X3;!D1;!$(NC=;!@[N,O,S]);$(N([#6;!D1;R])[#6;!D1;R]!=,@[!D1])]">(mol);
    validate_contains<"[c;X3;R;$([c]@[N,n,S,s,O,o])]-;!@[N;X3;!D1;!$(NC=;!@[N,O,S]);$(N([#6;!D1])[#6;!D1;R]!=,@[!D1])]">(mol);
    validate_contains<"[c;X3;R;$([c]@[N,n,S,s,O,o])]-;!@[O;D2;$(O([#6;!D1;R])[#6;!D1;R][!D1]);!$(OCO);!$(OC=;!@*);!$(O[P,S])]">(mol);
    validate_contains<"[c;X3;R;$([c]@[N,n,S,s,O,o])]-;!@[O;D2;$(O([#6;!D1;R])[#6;!D1][!D1]);!$(OCO);!$(OC=;!@*);!$(O[P,S])]">(mol);
    ...
    validate_contains<"[nH0;!$(n-C);!$(n(:c)(:c):a)]1ccccc1">(mol);
