...
void Rarey_smarts_part_185(Mol &mol)
{
    // SMARTS 921 - 925
...
template void Rarey_smarts_part_185<OpenBabel::OBMol>(OpenBabel::OBMol &mol);
template void Rarey_smarts_part_185<RDKit::ROMol>(RDKit::ROMol &mol);
