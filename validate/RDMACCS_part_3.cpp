...
void RDMACCS_part_3(OpenBabel::OBMol &mol)
{
    ...
    validate_contains<"[CH3]~[CH2]~[!#1]">(mol);
    validate_contains<"[CH3]~*~[CH2]~[!#1]">(mol);
    validate_contains<"[$([CH3]~*~*~[CH2]~[!#1]),$([CH3]~*1~*~[CH2]1)]">(mol);
    validate_contains<"[#7]~*~[#8]">(mol);
    validate_contains<"[$([!#1]~[CH2]~[CH2]~[!#1]),$(*1~[CH2]~[CH2]1)]">(mol);
    ...
    validate_contains<"*@*!@[#8]">(mol);
    validate_contains<"[$([!#1]~[CH2]~*~*~*~[CH2]~[!#1]),$([R]1@[CH2;R]@[R]@[R]@[R]@[CH2;R]1),$([!#1]~[CH2]~[R]1@[R]@[R]@[CH2;R]1),$([!#1]~[CH2]~*~[R]1@[R]@[CH2;R]1)]">(mol);
    validate_contains<"[$([!#1]~[CH2]~*~*~[CH2]~[!#1]),$([R]1@[CH2]@[R]@[R]@[CH2;R]1),$([!#1]~[CH2]~[R]1@[R]@[CH2;R]1)]">(mol);
    validate_contains<"[!#6;!#1]~[!#6;!#1]">(mol);
    ...
    validate_contains<"*~1~*~*~*~*~*~1">(mol);
    validate_contains<"[#8]">(mol);
    validate_contains<"[$([!#1]~[CH2]~[CH2]~[!#1]),$([R]1@[CH2;R]@[CH2;R]1)]">(mol);
