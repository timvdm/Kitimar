...
{
    Mol mol;
    addMockAtom(mol, 0, 8, 0, 0, 1, 1, 0, false, false);
    addMockAtom(mol, 1, 6, 0, 0, 2, 2, 0, false, false);
    addMockAtom(mol, 2, 6, 0, 0, 3, 1, 0, false, false);
    addMockAtom(mol, 3, 8, 0, 0, 1, 1, 0, false, false);
    addMockAtom(mol, 4, 6, 0, 0, 2, 2, 0, false, false);
    addMockAtom(mol, 5, 8, 0, 0, 1, 1, 0, false, false);
    addMockBond(mol, 0, 0, 1, 1, false, false);
    addMockBond(mol, 1, 1, 2, 1, false, false);
    addMockBond(mol, 2, 2, 3, 1, false, false);
    addMockBond(mol, 3, 2, 4, 1, false, false);
